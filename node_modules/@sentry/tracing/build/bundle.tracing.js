...
var Sentry = (function (exports) {
    ...
    ***************************************************************************** */
    ...
    function registerBackgroundTabDetection() {
        if (global$6 && global$6.document) {
            global$6.document.addEventListener('visibilitychange', function () {
                var activeTransaction = getActiveTransaction();
                if (global$6.document.hidden && activeTransaction) {
    ...
    var MetricsInstrumentation = /** @class */ (function () {
        function MetricsInstrumentation(_options) {
            ...
            if (!isNodeEnv() && ((_a = global$7) === null || _a === void 0 ? void 0 : _a.performance) && ((_b = global$7) === null || _b === void 0 ? void 0 : _b.document)) {
        ...
        MetricsInstrumentation.prototype.addPerformanceEntries = function (transaction) {
            ...
            var entryScriptSrc;
            if (global$7.document && global$7.document.scripts) {
                // eslint-disable-next-line @typescript-eslint/prefer-for-of
                for (var i = 0; i < global$7.document.scripts.length; i++) {
                    // We go through all scripts on the page and look for 'data-entry'
                    // We remember the name and measure the time between this script finished loading and
                    // our mark 'sentry-tracing-init'
                    if (global$7.document.scripts[i].dataset.entry === 'true') {
                        entryScriptSrc = global$7.document.scripts[i].src;
                        break;
                    }
                }
            }
            ...
            global$7.performance
                ...
                switch (entry.entryType) {
                    ...
                    case 'resource': {
                        var resourceName = entry.name.replace(global$7.location.origin, '');
    ...
    function instrumentRoutingWithDefaults(customStartTransaction, startTransactionOnPageLoad, startTransactionOnLocationChange) {
        ...
        if (startTransactionOnPageLoad) {
            activeTransaction = customStartTransaction({ name: global$8.location.pathname, op: 'pageload' });
        }
            ...
            addInstrumentationHandler({
                callback: function (_a) {
                    ...
                    if (from !== to) {
                        ...
                        activeTransaction = customStartTransaction({ name: global$8.location.pathname, op: 'navigation' });
                    }
                },
                type: 'history',
            });
